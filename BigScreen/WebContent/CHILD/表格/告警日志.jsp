<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <%@ page import="com.web.tuopu.Config" %>
...
<script>
	...
	function update()
	{
		$.get('${pageContext.request.contextPath}/Servlet_Gao?method=Create_root_json',function(jdata){
    ...
    layui.config({
        ...
        var renderTable1 = function () {
            treetable.render({
                ...
                treeLinkage: false,
                elem: '#table1',
                url: '${pageContext.request.contextPath}/Servlet_Gao?method=Create_root_json',
                page: false,
                cols: [[
                    {type: 'numbers'},
                    {field: 'time', title: '时间'},
                    {field: 'file', title: '文件 '},
                    {field: 'sys', title: '系统号'},
                    {field: 'node', title: '节点号'},
                    {field: 'info', title: '告警信息'},
                    {field: 'pre', title: '预测值'},
                ]]
            });
        };
